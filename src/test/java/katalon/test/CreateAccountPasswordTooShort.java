...
public class CreateAccountPasswordTooShort {
  ...
  public void testCreateAccountPasswordTooShort() throws Exception {
    ...
    driver.findElement(By.id("passwordConfirm")).sendKeys("hola");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Create your account'])[1]/following::button[1]")).click();
    assertEquals("Try one with at least 8 characters.", driver.findElement(By.id("password.errors")).getText());
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).clear();
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Try one with at least 8 characters.'])[1]/following::button[1]")).click();
