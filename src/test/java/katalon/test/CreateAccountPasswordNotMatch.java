...
public class CreateAccountPasswordNotMatch {
  ...
  @Test
  public void testCreateAccountPasswordNotMatch() throws Exception {
    ...
    driver.findElement(By.id("passwordConfirm")).sendKeys("contraseña2");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Create your account'])[1]/following::button[1]")).click();
    assertEquals("These passwords don't match.", driver.findElement(By.id("passwordConfirm.errors")).getText());
    driver.findElement(By.id("passwordConfirm")).click();
    driver.findElement(By.id("passwordConfirm")).clear();
    driver.findElement(By.id("passwordConfirm")).sendKeys("contrase?a");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)=concat('These passwords don', \"'\", 't match.')])[1]/following::button[1]")).click();
